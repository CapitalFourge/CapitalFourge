...
## Codebase Intelligence for Finsight (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-18 (commit 31dfa34)
...
- `frontend/app/(dashboard)/explorer/[symbol]/page.tsx` — 41 commits/90d (99.4th %ile)
- `frontend/components/trading/tradingview-chart.tsx` — 35 commits/90d (98.8th %ile)
- `frontend/app/(dashboard)/dashboard/page.tsx` — 10 commits/90d (98.2th %ile)
- `frontend/components/trading/enhanced-price-chart.tsx` — 13 commits/90d (97.6th %ile)
- `data-collector/src/infrastructure/grpc_server.py` — 12 commits/90d (97.0th %ile)

### Code health
Three co-equal signals: defect risk 8.09/10 avg, hotspot health 5.42/10 (stable), worst `data-collector/main.py` at 1.65/10 · maintainability 9.09/10 · performance risk 15 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `frontend/components/trading/fundamental-metric-selector.tsx` — churn risk — impact −2.4
- `frontend/app/(dashboard)/settings/page.tsx` — prior defect — impact −2.0
- `frontend/app/(dashboard)/strategies/page.tsx` — prior defect — impact −2.0
- `frontend/app/(dashboard)/transactions/page.tsx` — prior defect — impact −2.0
- `frontend/components/footer.tsx` — prior defect — impact −2.0
