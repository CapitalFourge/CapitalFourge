...
class FinancialDataServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SearchSymbols = channel.unary_unary(
                '/financial.FinancialDataService/SearchSymbols',
                request_serializer=financial__data__pb2.SearchRequest.SerializeToString,
                response_deserializer=financial__data__pb2.CategorizedAssetsResponse.FromString,
                _registered_method=True)


class FinancialDataServiceServicer:
    """Missing associated documentation comment in .proto file."""
...
def add_FinancialDataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SearchSymbols': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=financial__data__pb2.SearchRequest.FromString,
                    response_serializer=financial__data__pb2.CategorizedAssetsResponse.SerializeToString,
            ),
    }
...
class FinancialDataService:
    ...
    def SearchSymbols(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/financial.FinancialDataService/SearchSymbols',
            financial__data__pb2.SearchRequest.SerializeToString,
            financial__data__pb2.CategorizedAssetsResponse.FromString,
            options,
            channel_credentials,
            insecure,
