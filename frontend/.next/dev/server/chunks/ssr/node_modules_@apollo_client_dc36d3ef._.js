...
class ObservableQuery {
    ...
    */ getCacheDiff({ optimistic = true } = {}) {
    ...
    fetchMore({ query, variables, context, errorPolicy, updateQuery }) {
        ...
        const subscription = observable.pipe(operator, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filter"])((notification)=>notification.kind === "N" && notification.source === "network")).subscribe({
            next: (notification)=>{
                wasUpdated = false;
...
class QueryManager {
    ...
    async mutate({ mutation, variables, optimisticResponse, updateQueries, refetchQueries = [], awaitRefetchQueries = false, update: updateWithProxyFn, onQueryUpdated, fetchPolicy, errorPolicy, keepRootFields, context }) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            }, variables, fetchPolicy, {}, false).observable.pipe(validateDidEmitValue(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mergeMap"])((result)=>{
                const storeResult = {
                    ...result
                };
    ...
    getResultsFromLink(options, { queryInfo, cacheWriteBehavior, observableQuery, exposeExtensions }) {
        ...
        return this.getObservableFromLink(linkDocument, options.context, options.variables, options.fetchPolicy).observable.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["map"])((incoming)=>{
...
class ApolloCache {
    ...
    */ watchFragment(options) {
        ...
        const observable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$client$2f$utilities$2f$internal$2f$combineLatestBatched$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["combineLatestBatched"])(observables).pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["map"])(toResult), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tap"])({
            subscribe: ()=>subscribed = true,
            unsubscribe: ()=>subscribed = false
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shareReplay"])({
            bufferSize: 1,
            refCount: true
        }));
        return Object.assign(observable, {
    ...
    watchSingleFragment(id, fragmentQuery, options) {
        ...
        if (!cacheEntry.observable) {
            ...
            const observable = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
                subscribed = true;
                ...
                resetOnRefCountZero: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["timer"])(0)
            }));
...
const nullObservable = Object.assign(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
...
const emptyArrayObservable = Object.assign(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
...
//# sourceMappingURL=node_modules_%40apollo_client_dc36d3ef._.js.map