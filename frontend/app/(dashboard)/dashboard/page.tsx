              ...
              <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="space-y-3 rounded-[1.6rem] border border-white/8 bg-white/[0.03] p-4">
                  {portfolios.length > 0 ? (
                    ...
                    <div className="flex min-h-[160px] flex-col items-center justify-center rounded-[1.2rem] border border-dashed border-white/10 bg-white/[0.02] px-5 py-6 text-center">
                      <p className="text-sm text-slate-400">Aún no tienes portafolios creados</p>
                      <p className="mt-1 text-xs text-slate-500">Crea uno para verlo aquí</p>
                    </div>
                  )}
                </div>
