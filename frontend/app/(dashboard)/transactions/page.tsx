...
export default function TransactionsPage() {
    ...
    const allTransactions = data?.portfolios?.flatMap((p: Portfolio) =>
        p.transactions.map((t: Transaction) => ({ ...t, portfolioName: p.name }))
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {allTransactions.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={7} className="text-center py-20 text-slate-600 italic">
