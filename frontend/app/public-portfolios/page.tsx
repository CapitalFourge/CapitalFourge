...
export default function PublicPortfoliosPage() {
  ...
  const rankings = useMemo(() => {
    ...
    return list.filter((p: LeaderboardEntry) =>
      ...
      p.positions.some((pos: LeaderboardPosition) =>
      ...
      <section className="panel overflow-hidden p-8 sm:p-10 relative">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300">
            Descubre las carteras públicas con mayor rendimiento. Explora
            estrategias de otros traders y aprende de sus asignaciones.
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-col gap-4 md:flex-row md:items-center">
          ...
          <div className="flex items-center gap-6 px-4">
            <div className="text-center">
              <p className="text-xs uppercase tracking-widest text-slate-500">Portafolios</p>
                ...
                <CardContent className="flex items-center gap-6 p-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3">
                      ...
                      {index < 3 && <TrendingUp className="h-4 w-4 text-emerald-300" />}
                    </div>
