        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="bg-white text-black hover:bg-slate-200 font-bold gap-2 rounded-2xl h-12">
                    <Plus className="w-5 h-5" /> CREAR PORTAFOLIO
                </Button>
            </DialogTrigger>
            <DialogContent className="glass border-none text-white sm:max-w-md">
                ...
                <div className="space-y-4 py-4">
                    <div className="space-y-2">
                        <label className="text-xs uppercase tracking-[0.2em] text-slate-500 font-bold">Nombre del Portafolio</label>
                        <Input
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            placeholder="Detalles sobre la estrategia de inversión..."
                            value={description}
