...
public class AssetSearchServiceFallbackTest {
    ...
    void returnsFallbackAssetsWhenGrpcFails() {
        ...
        com.capitalfourge.portfoliomanager.application.ports.out.MetricRepository mockMetrics = mock(
                com.capitalfourge.portfoliomanager.application.ports.out.MetricRepository.class);
        // Simulate failure
